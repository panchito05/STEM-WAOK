...
export default function DivisionModuleCard({ module, index }: DivisionModuleCardProps) {
  ...
  return (
    <div className="division-module-unique-card division-specific-container h-full bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 overflow-hidden border border-gray-200 hover:border-blue-300 group">
      ...
      <div className="division-body-unique division-main-content p-2 sm:p-2 bg-gradient-to-b from-white to-blue-50 pt-[13px] pb-[13px] pl-[12px] pr-[12px] mt-[0px] mb-[0px] ml-[0px] mr-[0px]">
        <p className="division-description-text text-xs sm:text-sm mb-2 line-clamp-2 text-gray-600">
