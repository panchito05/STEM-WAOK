  ...
  return (
    <div className="multiplication-module-unique-card multiplication-specific-container h-full bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 overflow-hidden border border-gray-200 hover:border-green-300 group">
      ...
      <div className="multiplication-header-unique bg-gradient-to-br from-green-500 via-green-600 to-green-700 text-white p-2 sm:p-3 lg:p-4 relative overflow-hidden">
        ...
        <div className="multiplication-title-section relative flex items-center justify-between">
          <div className="multiplication-content-wrapper flex items-center min-w-0 flex-1">
            <div className="multiplication-icon-wrapper mr-2 sm:mr-3 bg-white/25 p-1 sm:p-2 rounded-lg shadow-inner flex-shrink-0">
              <X className="h-4 w-4 min-[400px]:h-5 min-[400px]:w-5 sm:h-6 sm:w-6 text-white" />
            </div>
            <h3 className="multiplication-title-text text-xs min-[350px]:text-sm sm:text-base md:text-lg lg:text-xl font-bold text-white line-clamp-2 leading-tight">
              Multiplicación
            </h3>
          </div>
          
          {/* Iconos en la esquina superior derecha */}
          <div className="multiplication-top-actions flex items-center gap-1 min-[400px]:gap-2 flex-shrink-0">
            <button 
              className={`multiplication-favorite-button focus:outline-none p-1 min-[400px]:p-1.5 sm:p-1.5 rounded-full transition-all ${
                isModuleFavorite 
      ...
      <div className="multiplication-body-unique multiplication-main-content p-2 sm:p-4 bg-gradient-to-b from-white to-green-50 pt-[13px] pb-[13px] pl-[12px] pr-[12px] mt-[0px] mb-[0px] ml-[0px] mr-[0px]">
        ...
        <div className="multiplication-footer-unique multiplication-bottom-section flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
          <div className="multiplication-difficulty-wrapper flex items-center w-full sm:w-auto">
            <span className={`multiplication-difficulty-label px-1.5 min-[400px]:px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-[10px] min-[400px]:text-xs sm:text-sm font-medium border ${difficultyColors[module.difficulty as keyof typeof difficultyColors] || difficultyColors.beginner} flex-shrink-0`}>
