...
jest.mock('../utils', () => {
  ...
  return {
    ...originalModule,
    generateAssociativePropertyProblem: jest.fn(),
...
// La función generateAssociativePropertyProblem devuelve un problema de suma simple para las pruebas
...
describe('Componente Exercise de suma', () => {
  ...
  beforeEach(() => {
    ...
    (utils.generateAssociativePropertyProblem as jest.Mock).mockImplementation(mockGenerateProblem);
  });
  ...
  test('genera problemas según la dificultad configurada', () => {
    ...
    // Assert - Verificar que se llamó a generateAssociativePropertyProblem con la dificultad correcta
    expect(utils.generateAssociativePropertyProblem).toHaveBeenCalledWith('intermediate');
  });
