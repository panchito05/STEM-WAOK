// Tests para los adaptadores de tipos entre AssociativePropertyProblem y Problem
import { 
...
import { 
  ...
  problemToAssociativePropertyProblem 
} from '../utils';

describe('Adaptadores de tipos', () => {
  // Caso de prueba: Conversión de AssociativePropertyProblem a Problem
  describe('additionProblemToProblem', () => {
    test('convierte correctamente un problema de suma sin decimales', () => {
      ...
      const additionProblem: AssociativePropertyProblem = {
        id: '123',
        operands: [5, 7],
        correctAnswer: 12,
        layout: 'horizontal',
  ...
  // Caso de prueba: Conversión de Problem a AssociativePropertyProblem
  describe('problemToAssociativePropertyProblem', () => {
    test('convierte correctamente un problema sin decimales', () => {
      ...
      // Act - Convertir a AssociativePropertyProblem
      const additionProblem = problemToAssociativePropertyProblem(problem);
    ...
    test('maneja correctamente casos con displayFormat no válido', () => {
      // Arrange - Problema con formato inválido para AssociativePropertyProblem
      const problem: Problem = {
        id: '123',
        operands: [{ value: 5 }, { value: 7 }],
        correctAnswer: 12,
        displayFormat: 'word', // No es válido para AssociativePropertyProblem
        difficulty: 'elementary',
        allowDecimals: false,
        maxAttempts: 3
      };
