// Exercise.tsx - Subtraction Module (exact copy from Addition with subtraction changes)
...
// UserAnswer interface for subtraction
...
export default function SubtractionExercise({ settings, onOpenSettings }: ExerciseProps) {
  ...
  const generateNewProblemSet = () => {
    ...
    for (let i = 0; i < settings.problemCount; i++) {
      const problem = generateSubtractionProblem(adaptiveDifficulty);
      problem.index = i + 1;
        ...
        {digitValues.map((digit, index) => (
          <input
            ...
            className={`w-10 h-12 sm:w-11 sm:h-14 text-xl sm:text-2xl font-bold border-2 rounded-md text-center transition-all select-none ${
              index === focusedDigitIndex ? 'border-red-500 ring-2 ring-red-300 shadow-lg' : 'border-gray-300'
    ...
    return (
      <div className="text-center space-y-6 p-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
          <Button onClick={generateNewProblemSet} className="w-full sm:w-auto bg-red-600 hover:bg-red-700">
  ...
  return (
    <div className="relative">
      {/* Header exactamente como addition pero con colores de resta */}
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 sm:p-4 mb-3 sm:mb-4">
        ...
        <div className="flex items-center justify-between sm:justify-center gap-1 sm:gap-4 text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4 flex-wrap">
          ...
          <span className="hidden sm:inline font-semibold px-2 py-1 border border-gray-300 rounded-md text-xs bg-[#dc2626] text-[#ffffff]">
          ...
          <div className="flex flex-col items-center">
            <button
              className="px-2 py-1 flex items-center justify-center text-red-600 border border-gray-300 rounded-md h-7 hover:bg-red-50"
        ...
        <div className="mt-4 sm:mt-6 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
          ...
          {viewingPrevious ? (
            ...
            <Button 
              ...
              className="w-full sm:w-auto px-5 sm:px-6 text-sm sm:text-base md:text-lg bg-red-500 hover:bg-red-600 text-white h-12 sm:h-10 order-2 sm:order-2"
            >
