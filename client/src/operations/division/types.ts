...
export interface DivisionProblem {
  id: string;
  operands: number[];       // Operandos de la división [dividendo, divisor]
  num1?: number;            // Campo legacy para compatibilidad (dividendo)
  num2?: number;            // Campo legacy para compatibilidad (divisor)
