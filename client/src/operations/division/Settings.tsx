...
export default function Settings({ settings, onBack }: SettingsProps) {
    ...
    switch (difficulty) {
      ...
      case "intermediate":
        return {
          ...
          bgContainer: "bg-teal-50",
          bgLight: "bg-teal-100",
          bgMedium: "bg-teal-200",
  ...
  const subheaderText = isEnglish ? "Customize your division exercise experience" : "Personaliza tu experiencia de ejercicio de división";
        ...
        <div className={`p-4 rounded-lg shadow-sm ${theme.bgContainer} border ${theme.border}`}>
          ...
          <div className="mt-3 mb-2 space-y-1.5">
            <p className={`text-sm ${theme.accent} bg-white/60 rounded-md p-2 border ${theme.border}`}>
              <span className="font-bold">{isEnglish ? "Beginner:" : "Principiante:"}</span> {isEnglish ? "Simple divisions (8÷2, 15÷3)" : "Divisiones simples (8÷2, 15÷3)"}
            </p>
            <p className={`text-sm ${theme.accent} bg-white/60 rounded-md p-2 border ${theme.border}`}>
              <span className="font-bold">{isEnglish ? "Elementary:" : "Elemental:"}</span> {isEnglish ? "Two-digit by one-digit divisions (24÷3, 48÷6)" : "Divisiones de dos dígitos entre un dígito (24÷3, 48÷6)"}
            </p>
            <p className={`text-sm ${theme.accent} bg-white/60 rounded-md p-2 border ${theme.border}`}>
              <span className="font-bold">{isEnglish ? "Intermediate:" : "Intermedio:"}</span> {isEnglish ? "Divisions with larger numbers (84÷12, 156÷13)" : "Divisiones con números más grandes (84÷12, 156÷13)"}
            </p>
            <p className={`text-sm ${theme.accent} bg-white/60 rounded-md p-2 border ${theme.border}`}>
              <span className="font-bold">{isEnglish ? "Advanced:" : "Avanzado:"}</span> {isEnglish ? "Complex divisions with decimals (125÷25, 384÷16)" : "Divisiones complejas con decimales (125÷25, 384÷16)"}
            </p>
            <p className={`text-sm ${theme.accent} bg-white/60 rounded-md p-2 border ${theme.border}`}>
              <span className="font-bold">{isEnglish ? "Expert:" : "Experto:"}</span> {isEnglish ? "Very complex divisions (1575÷35, 2496÷48)" : "Divisiones muy complejas (1575÷35, 2496÷48)"}
            </p>
          </div>
        </div>
