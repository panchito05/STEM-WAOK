    ...
    <div className="relative">
      ...
      <div className={`px-2 py-3 sm:px-4 sm:py-5 rounded-xl shadow-lg ${ adaptiveDifficulty === "beginner" ? "bg-sky-50 border-sky-200" : adaptiveDifficulty === "elementary" ? "bg-lime-50 border-lime-200" : "bg-green-50 border-green-200" } border-2`}>
        <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800">{t('addition.title')}</h2>
            <div className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm">
                ...
                <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full font-semibold capitalize">
                    {t('common.level')}: {t(settings.enableAdaptiveDifficulty ? adaptiveDifficulty : settings.difficulty)}
                </span>
        ...
        <div className="mt-4 sm:mt-6 flex justify-between items-center">
          ...
          {viewingPrevious ? (
            ...
            <Button onClick={handleContinue} className="px-5 sm:px-6 py-2.5 sm:py-3 text-base sm:text-lg animate-pulse bg-green-500 hover:bg-green-600 text-white flex items-center justify-center w-full max-w-xs mx-auto">
                <span className="flex-grow text-center font-medium">{t('common.continue')}</span>
                <TooltipProvider delayDuration={300}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div 
