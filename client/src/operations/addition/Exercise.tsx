...
export default function Exercise({ settings, onOpenSettings }: ExerciseProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className={`px-2 py-2 sm:px-4 sm:py-5 rounded-xl shadow-lg min-h-[calc(100vh-6rem)] md:min-h-0 flex flex-col ${
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4 mb-2 sm:mb-4">
        ...
        <div className={`p-2 sm:p-4 md:p-6 rounded-lg mb-2 sm:mb-4 shadow-md bg-white flex-grow flex flex-col items-center justify-center max-h-[35vh] sm:max-h-none`}>
