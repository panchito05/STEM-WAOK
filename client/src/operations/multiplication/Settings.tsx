        ...
        <div>
          ...
          <div className="mt-2">
            ...
            <p className="mt-1 text-sm text-gray-500">
              <span className="font-medium">Beginner:</span> Multiplication with single digits (1-9)
            </p>
            <p className="text-sm text-gray-500">
              <span className="font-medium">Intermediate:</span> Multiplication with tables up to 12
            </p>
            <p className="text-sm text-gray-500">
              <span className="font-medium">Advanced:</span> Multiplication with two-digit numbers
            </p>
          </div>
        </div>
