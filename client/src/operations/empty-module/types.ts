// Definición de tipos para el módulo genérico
...
// Definición de un problema genérico específico
export interface EmptyModuleProblem {
  id: string;
  operands: number[];       // Operandos del problema (puede ser más de 2 en niveles avanzados)
...
export interface Problem {
  id: string;
  operands: Operand[];
  operator?: string;       // El operador matemático
