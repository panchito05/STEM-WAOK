...
interface ProfessorState {
  ...
  currentProblem: AdditionCopyProblem | null;
  userAnswer: string;
...
type ProfessorAction =
  | { type: 'SET_PROBLEM'; payload: AdditionCopyProblem }
...
interface ProfessorContextType {
  ...
  setProblem: (problem: AdditionCopyProblem) => void;
...
interface ProfessorProviderProps {
  ...
  initialProblem?: AdditionCopyProblem;
...
export const ProfessorProvider: React.FC<ProfessorProviderProps> = ({
  ...
  const contextValue: ProfessorContextType = {
    ...
    setProblem: (problem: AdditionCopyProblem) => 
