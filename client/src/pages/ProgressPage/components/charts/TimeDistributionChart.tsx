...
export function TimeDistributionChart({ moduleProgress }: TimeDistributionChartProps) {
  ...
  const chartData = operationModules
    ...
    .map(module => {
      ...
      return {
        ...
        averageTime: progress?.averageTime ? Math.round(progress.averageTime) : 0,
        color: getModuleColor(module.id),
        id: module.id
      };
    })
    .sort((a, b) => a.averageTime - b.averageTime); // Ordenar de menor a mayor tiempo (más rápido primero)
